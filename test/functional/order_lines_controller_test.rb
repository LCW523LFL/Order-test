...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { id: @order_line.id, items: @order_line.items, num: @order_line.num, status: @order_line.status, time: @order_line.time, user_id: @order_line.user_id }
    end
  ...
  test "should update order_line" do
    put :update, id: @order_line, order_line: { id: @order_line.id, items: @order_line.items, num: @order_line.num, status: @order_line.status, time: @order_line.time, user_id: @order_line.user_id }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
